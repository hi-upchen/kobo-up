...
export function DropdownItem({
  ...
  const classes = clsx(
    ...
    '[&>[data-slot=icon]]:text-zinc-500 [&>[data-slot=icon]]:data-[focus]:text-white [&>[data-slot=icon]]:dark:text-zinc-300 [&>[data-slot=icon]]:data-[focus]:dark:text-white',
    // Avatar
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr,auto] gap-x-12 px-3.5 pb-1 pt-2 text-sm/5 font-medium text-zinc-500 sm:px-3 sm:text-xs/5 dark:text-zinc-300'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-zinc-500 group-data-[focus]:text-white sm:text-xs/5 dark:text-zinc-300 forced-colors:group-data-[focus]:text-[HighlightText]'
      )}
    />
  )
}
